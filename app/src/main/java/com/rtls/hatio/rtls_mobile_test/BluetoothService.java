...
public class BluetoothService {
    ...
    private ConnectThread mConnectThread; // ∫Øºˆ∏Ì ¥ŸΩ√
    private ConnectedThread mConnectedThread; // ∫Øºˆ∏Ì ¥ŸΩ√
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            // µπŸ¿ÃΩ∫ ¡§∫∏∏¶ æÚæÓº≠ BluetoothSocket ª˝º∫
            try {
        ...
        public void run() {
            ...
            // ø¨∞·¿ª Ω√µµ«œ±‚ ¿¸ø°¥¬ «◊ªÛ ±‚±‚ ∞Àªˆ¿ª ¡ﬂ¡ˆ«—¥Ÿ.
            // ±‚±‚ ∞Àªˆ¿Ã ∞Ëº”µ«∏È ø¨∞·º”µµ∞° ¥¿∑¡¡ˆ±‚ ∂ßπÆ¿Ã¥Ÿ.
            btAdapter.cancelDiscovery();

            // BluetoothSocket ø¨∞· Ω√µµ
            try {
                // BluetoothSocket ø¨∞· Ω√µµø° ¥Î«— return ∞™¿∫ succes ∂«¥¬ exception¿Ã¥Ÿ.
                mmSocket.connect();
                Log.d(TAG, "Connect Success");

            } catch (IOException e) {
                connectionFailed(); // ø¨∞· Ω«∆–Ω√ ∫“∑Øø¿¥¬ ∏ﬁº“µÂ
                ...
                // ø¨∞·¡ﬂ? »§¿∫ ø¨∞· ¥Î±‚ªÛ≈¬¿Œ ∏ﬁº“µÂ∏¶ »£√‚«—¥Ÿ.
                BluetoothService.this.start();
                return;
            }

            // ConnectThread ≈¨∑°Ω∫∏¶ reset«—¥Ÿ.
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            // BluetoothSocket¿« inputstream ∞˙ outputstream¿ª æÚ¥¬¥Ÿ.
            try {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    // InputStream¿∏∑Œ∫Œ≈Õ ∞™¿ª πﬁ¥¬ ¿–¥¬ ∫Œ∫–(∞™¿ª πﬁ¥¬¥Ÿ)
